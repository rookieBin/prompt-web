...
- ✅ 左侧可折叠抽屉导航（添加提示词）
- ✅ 提示词广场
  - 推荐板块（紧凑列表展示，Popover 交互）
  - 热门板块（紧凑列表展示，Popover 交互）
  - 分类筛选（编程开发、文案写作、商务办公、设计创意、数据分析、其他）
  - 卡片展示、搜索、分页
- ✅ 提示词使用（AI对话Modal）
- ✅ 提示词收藏功能
- ✅ 个人中心（用户信息、AI API配置）
...
- `promptApi` - 提示词相关API
  - `getPrompts()` - 获取提示词列表（支持分类和关键词筛选）
  - `getRecommendedPrompts()` - 获取推荐提示词
  - `getHotPrompts()` - 获取热门提示词
...
详细的 API 接口文档请查看 `docs/API接口文档.md`
